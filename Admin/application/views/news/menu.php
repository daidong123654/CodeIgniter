...
<div id="menu" class="x-panel x-border-panel x-tree " style="width: 225px; position: absolute; visibility: visible; left:5px; z-index:1; height:100% ">
  ...
  <div  class="x-panel-bwrap ">
    ...
    <li class="x-tree-node">
	  ...
	  <li class="x-tree-node"><div  class="x-tree-node-el x-tree-node-leaf feed" ><span class="x-tree-node-indent"><img class="x-tree-icon" src="<?php echo base_url()?>images/s.gif"/></span><img  class="x-tree-node-icon feed-icon" src="<?php echo base_url()?>images/rss_search2.png"/><a href="<?php echo site_url('news/search')?>" target="main-frame"><span >查找新闻</span></a></div></li>
	  
	  <li class="x-tree-node"><div  class="x-tree-node-el x-tree-node-leaf feed" ><span class="x-tree-node-indent"><img class="x-tree-icon" src="<?php echo base_url()?>images/s.gif"/></span><img  class="x-tree-node-icon add-feed" src="<?php echo base_url()?>images/rss_delete.gif"/><a  href="<?php echo site_url('news/delete')?>" target="main-frame" ><span >删除新闻</span></a></div></li>
