	...
	<!--<button class="btn btn-large btn-block" type="button" >-->	
		<tr>		
			...
			<td ><div class="x-grid3-cell-inner ">
			 <a href='<?php echo site_url('ISBN/edit/id/'.$value['ISBN'])?>' style="text-decoration:none" alt='编辑' title='编辑'>
			 <img src="<?php echo base_url()?>images/icon_edit.gif" border="0" width="16" height="16">
			 </a>&nbsp;&nbsp&nbsp;&nbsp;
			  <a href='#' onclick="delete_a('<?php echo $value['ISBN'];?>')" style="text-decoration:none" alt='删除' title='删除'>
